  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/what-is-wildteach"
          element={<LandingPage section="what-is-wildteach" />}
        />
        <Route path="/about-us" element={<LandingPage section="about-us" />} />
        <Route
          path="/contact-us"
          element={<LandingPage section="contact-us" />}
        />
        <Route
          path="/login"
          element={
        ...
        />
        <Route
          path="/tutee/settings-tutee"
          element={
            <ProtectedRoute
              element={<SettingsTutee />}
              isLoggedIn={isLoggedIn}
              allowedRoles={["tutee"]}
              userRole={userRole}
            />
